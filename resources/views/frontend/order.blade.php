...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <h2 class="page-title">TÓM TẮT GIỎ HÀNG-MUA SẮM<span class="shop-pro-item">Giỏ hàng của bạn có: 2 sản phẩm</span></h2>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered" id="cart-summary">
                ...
                <tr class="cart-total-price">
                    ...
                    <td class="text-right" colspan="3">Tổng số sản phẩm (chưa bao gồm thuế.)</td>
                    <td id="total_product" class="price" colspan="1">$76.46</td>
                </tr>
                <tr>
                    <td class="text-right" colspan="3">Tổng số vận chuyển</td>
                    <td id="total_shipping" class="price" colspan="1">$5.00</td>
                </tr>
                <tr>
                    <td class="text-right" colspan="3">Tổng số chứng từ (chưa bao gồm thuế)</td>
            ...
            <ul class="address">
                <li>
                    <h3 class="page-subheading box-subheading">
                        ĐỊA CHỈ GIAO HÀNG (VĂN PHÒNG BOOTEXPERTS)
                    </h3>
                </li>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="second_item primari-box mycartaddress-info">
            ...
            <ul class="address">
                <li>
                    <h3 class="page-subheading box-subheading">
                        ĐỊA CHỈ HÓA ĐƠN (TRANG CHỦ BOOTEXPERTS)
                    </h3>
                </li>
                <li><span class="address_name">BootExperts</span></li>
                <li><span class="address_company">Web development Company</span></li>
